...
Once approved, you’ll gain access to a stream of projects from our international client community. Now you’re ready to provide your services to thousands of business — go get ‘em!    </p>
    <button
      style={{
...
<section style={{ display: 'flex', width: '100vw', height: '600px' }}>
  ...
  <div style={{ width: '50%', padding: '40px', backgroundColor: '#ffffff', boxSizing: 'border-box' }}>
    ...
    <p style={{ color: '#5b21b6', marginBottom: '24px' }}>
      As a freelancer on PeoplePerHour, our artificial intelligence system matches you to the most
      suitable projects based on your profile and abilities. You can search for projects manually
      or save automatic searches to notify you of new projects. Find projects that match your skill
      and ability then submit a compelling proposal to win the project. Send 15 proposals per month
      for free, if you want to quote on more projects you can buy additional credit.
    </p>
